namespace Helpers
{
    public static class SFSResponseHelper
    {
        ...
        public const string USER_PING = "ping";
        public const string USERS_START_GAME = "LoadGame";
        public const string KICK_USER_IN_ROOM = "kickUserInRoom";
        public const string UPDATE_LOBBY_DATA = "updateLobbyData";
